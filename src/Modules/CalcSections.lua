...
{ 1, "SkillTypeStats", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Skill type-specific Stats", data = {
	...
	{ label = "Time Until Explosion", flag = "brand", { format = "{2:output:PenanceTimeUntilExplosion}s",
		{ breakdown = "PenanceTimeUntilExplosion" },
		{ modName = "PenanceTimeUntilExplosion", cfg = "skill"},
	}, },
